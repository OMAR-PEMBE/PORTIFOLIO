...
<body>
    ...
    <!-- Start 404 
    ============================================= -->
    <div class="error-page-area default-padding-bottom pt-260 pt-md-180 pt-xs-140 text-center">
        <!-- Shape -->
    ...
    <!-- jQuery Frameworks
    ============================================= -->
    <?php require_once __DIR__ . '/includes/page-scripts.php'; renderPageScripts(); ?>
